...
import { BookOpen, Search, Eye, Bookmark, Check, Download, Printer } from 'lucide-vue-next';
            ...
            <div class="flex items-center space-x-2.5">
              <div class="flex items-center bg-slate-700 rounded-lg p-0.5 font-sans" id="reader-zoom-box">
                <button
                  ...
                  :class="[
                    'px-2.5 py-1 rounded text-[10px] font-black transition-colors cursor-pointer',
